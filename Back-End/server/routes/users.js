...
router.put('/profile', authenticateToken, async (req, res) => {
  console.log('🔍 Profile update route hit:', req.method, req.originalUrl);
...
router.put('/profile-picture', authenticateToken, async (req, res) => {
  console.log('🔍 Profile picture route hit:', req.method, req.originalUrl);
  console.log('🔍 Request body:', req.body);
  console.log('🔍 User ID:', req.user._id);
  ...
  try {
    ...
    console.log('✅ Profile picture received, updating user...');
